...
export const TransactionDetails = ({ transactionHash, isOpen, onClose }: TransactionDetailsProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto glass-morphism cyber-border neon-glow bg-gradient-to-br from-gray-900/80 to-gray-950/90 p-0 border-green-500/30 shadow-2xl">
